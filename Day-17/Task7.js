//Display all values and their data types in the console.
let name = "Aarthi";       
let age = 20;              
let isStudent = true;      
let marks = [85, 90, 95];  
let person = { firstName: "Aarthi", lastName: "Vaasugi" };
let score = null;          
let notAssigned;           
let bigNumber = 12345678901234567890n; 
let uniqueId = Symbol("id"); 
// Displaying all values and their data types
...
console.log("Value:", uniqueId, "| Type:", typeof uniqueId);
